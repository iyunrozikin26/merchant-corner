            ...
            <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
                ...
                <div className="flex items-center relative">
                    ...
                    <a className="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4" href="#">
                        ...
                        <span className="text-white bg-red-700 absolute rounded-full text-xs -mt-5 ml-2 py-0 px-1.5">9</span>
                    </a>
                    <a className="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4 dropdown-toggle hidden-arrow flex items-center" href="#" id="dropdownMenuButton1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span className="text-white bg-red-700 absolute rounded-full text-xs -mt-2.5 ml-2 py-0 px-1.5">3</span>
                    </a>
                    <div className="dropdown relative">
                        ...
                        {!show ? (
                            <ul className=" min-w-max absolute  bg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 m-0 bg-clip-padding border-none left-auto right-0" aria-labelledby="dropdownMenuButton2">
                                <li>
